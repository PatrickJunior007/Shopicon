<?php 
  ...
  $sql_price = "SELECT max(price) FROM product_ads WHERE category = 'tv_video'";
...
<body>
  ...
  <div class="page_wrapper">
    <div style="background-image: url(system_image/1915176.jpg); background-position-y: 5%; " class="first_banner_1">
      <div class="image_container_1">
        <div class="text_area">
          <h1 class="text-heading" style="">Tv & Video</h1>
        </div>
      </div>
    </div>
          ...
          <div style="align-self: center" class="card border-0 bg-light mt-2 d-flex p-1">
            <ol class="breadcrumb pt-2">
              ...
              <li class="breadcrumb-item active" aria-current="page">
                <a style="font-size: 16px" href="tv_video.php">Tv & Video</a>
              </li>
            </ol>
          </div>
        </nav>
        <div class="row my-4">
          <div class="col-md-4">
            <div class="filter_box px-lg-4">
              ...
              <form autocomplete="off" method="POST" action="search_result.php">
                <div class="form-group search_1">
                  <div class="d-flex justify-content-between align-item-center">
                    ...
                    <button type="button" class="btn btn-warning btn-sm"> <a style="color: inherit;" href="tv_video.php">Refresh Normal</a></button>
                  </div>
                  <div style="
                          height: 2px;
                          width: 50px;
              ...
              <form action="tv_video.php" method="POST">
                <div class="form-group search_1">
              ...
              <div class="btn_sorting d-flex mb-2">
                <?php
                  ...
                  if(isset($_POST['location'])){
                    ...
                    $loc_sql = "SELECT * FROM product_ads WHERE location = '$location' AND category = 'tv_video'";
                  ...
                  elseif(isset($_POST['ranging'])){
                    $range = $_POST['range'];
                    $loc_sql = "SELECT * FROM product_ads WHERE price <= '$range' AND category = 'tv_video'";
                    $result = mysqli_query($conn, $loc_sql);
                    ...
                    $sql = "SELECT * FROM product_ads WHERE category = 'tv_video'";
                        ...
                        <div class="filter_box1 px-1">
                          ...
                          <form autocomplete="off" method="POST" action="search_result.php">
                            <div class="form-group search_1">
                              <div class="d-flex justify-content-between align-item-center">
                                <h4 class="text-secondary">Search</h4>
                                <button type="button" class="btn btn-warning btn-sm"> <a href="tv_video.php"> Refresh</a></button>
                              </div>
              ...
              <div class="row px-0 mx-0 grid">
                <?php
                  ...
                  if(isset($_POST['location'])){
                    require_once('components/connect.php');
                    $location = $_POST['locationing'];
                    $sql = "SELECT * FROM product_ads WHERE location = '$location' AND category = 'tv_video'";
                    $result = mysqli_query($conn, $sql);
                  ...
                  elseif(isset($_POST['ranging'])){
                    $range = $_POST['range'];
                    $rng_sql = "SELECT * FROM product_ads WHERE price <= '$range' AND category = 'tv_video'";
